...
namespace AppWorkflow.Services.Interfaces
{
    ...
    public interface IWorkflowManagementService
    {
        ...
        /// </summary>
        Task<IEnumerable<WorkflowDto>> GetWorkflowVersionHistoryAsync(Guid workflowId, CancellationToken cancellationToken = default);

        /// <summary>
        /// Clones an existing workflow
        /// </summary>
        Task<WorkflowDto> CloneWorkflowAsync(Guid workflowId, CancellationToken cancellationToken = default);
    }
}
